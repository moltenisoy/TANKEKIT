...
from theme_matrix import get_matrix_style
from i18n import i18n

class MatrixUninstallerApp(UninstallerApp):
    def initUI(self):
        super().initUI()
        self.setStyleSheet(get_matrix_style())
        self.setWindowTitle(i18n.get("app_title") + " - MATRIX EDITION")
